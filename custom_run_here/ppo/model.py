...
#         return self._hidden_size
#     def forward_gru(self, x, hxs, masks):
...
#         self.train()
#     def forprop(self, inputs, rnn_hxs, masks):
...
#     metadata = {"models": ["quadrotor", "default"]}
#     def __init__(self, num_inputs, recurrent=False, hidden_size=64, model="default", quadrotor_model_path=None, quadrotor_weights_require_grad=True, bhidden_size=16):
