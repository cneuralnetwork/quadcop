...
class RolloutStorage(object):
    ...
    def feed_forward_generator(self, advantages, num_mini_batch=None, mini_batch_size=None):
        ...
        if mini_batch_size is None:
            assert batch_size >= num_mini_batch, (f"PPO requires the number of processes ({num_processes}) " "* number of steps ({num_steps}) = {num_processes * num_steps} " "to be greater than or equal to the number of PPO mini batches ({num_mini_batch}).")
    ...
    def recurrent_generator(self, advantages, num_mini_batch):
        ...
        assert num_processes >= num_mini_batch, (f"PPO requires the number of processes ({num_processes}) " "to be greater than or equal to the number of " "PPO mini batches ({num_mini_batch}).")
